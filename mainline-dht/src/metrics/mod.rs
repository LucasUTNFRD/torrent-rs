...
pub fn inc_msg_in() {
    counter!("dht.messages_in").increment(1);
}
pub fn inc_msg_out() {
    counter!("dht.messages_out").increment(1);
}
pub fn inc_msg_dropped() {
    counter!("dht.messages_dropped").increment(1);
}
pub fn inc_msg_out_dropped() {
    counter!("dht.messages_out_dropped").increment(1);
}

pub fn inc_bytes_in(n: usize) {
    counter!("dht.bytes_in").increment(n as u64);
}
pub fn inc_bytes_out(n: usize) {
    counter!("dht.bytes_out").increment(n as u64);
}
